...
You have a certain amount of money and you would like to know how many books of the same price you 
can purchase.
...
int main(void){
    ...
    double money;
    double book;
    scanf("%lf%lf", &money, &book);
    
    double bookAmount = money/book;
    
    int bookNum = (int) bookAmount;
